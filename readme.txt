LICENSE
On the PoCar Caronas website we use the template template created by Inovatik, which is offered for free use under the MIT open source license for any type and number of projects.
